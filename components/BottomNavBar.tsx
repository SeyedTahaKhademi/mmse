...
const BottomNavBar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-lg items-center justify-between rounded-[28px] border border-white/60 bg-white/90 md:bg-white/80 px-4 py-3 md:backdrop-blur-2xl shadow-2xl">
        {items.map((item) => (
          <NavItem
            key={item.href}
            {...item}
